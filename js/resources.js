...
export const SoilMudBackground = new Image();
SoilMudBackground.src = "Resources/SoilMud0059_2_S.jpg";
export const IntroScreenBackground = new Image();
IntroScreenBackground.src = "Resources/Plastic0027_1_S_Intro.png";
export const SnowBackground = new Image();
SnowBackground.src = "Resources/Snow0099_5_S.jpg";
export const SandPebblesBrownBackground = new Image();
SandPebblesBrownBackground.src = "Resources/SandPebbles0060_19_S.jpg";
export const SandPebblesRedBackground = new Image();
SandPebblesRedBackground.src = "Resources/SandPebbles0058_9_S_red_new.jpg";
export const SoilCrackedBackground = new Image();
SoilCrackedBackground.src = "Resources/SoilCracked0086_7_S.jpg";
...
export const eyeImage = new Image();
eyeImage.src = "Resources/monster_eye.png";
export const eyeShotImage = new Image();
eyeShotImage.src = "Resources/monster_eye_shot.png";
export const feederImage = new Image();
feederImage.src = "Resources/feeder.png";
