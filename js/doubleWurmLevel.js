...
export class DoubleWurmLevel extends TimedLevel {
    constructor(theme) {
        super(theme, 85000);
        this.combined_length_to_win = 18;
        this.min_length_to_win = 7;
        this.Name = "Double Trouble";
        this.Description = `Can you raise two wurms at once? Get a combined length of ${this.combined_length_to_win}, with each wurm at least ${this.min_length_to_win} to win!`;
        this.QuickObjectives = `Grow your wurms to at least ${this.min_length_to_win} each and at least ${this.combined_length_to_win} total.`;
    }
    InitializeLevel() {
...
//# sourceMappingURL=doubleWurmLevel.js.map